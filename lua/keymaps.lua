...
map("n", "<leader>sf", function() snacks_picker().picker.files() end, { desc = "[S]earch [F]ile" })
map("n", "<leader>sb", function() snacks_picker().picker.buffers() end, { desc = "[S]earch [B]uffer" })
map("n", "<leader>sg", function() snacks_picker().picker.grep() end, { desc = "[S]earch [G]rep" })
map("n", "<leader>sc", function()
  snacks_picker().picker.files({ cwd = vim.fn.stdpath("config") })
end, { desc = "[S]earch [C]onfig file" })
map("n", "<leader>sh", function() snacks_picker().picker.command_history() end, { desc = "[S]earch command [h]istory" })
map("n", "<leader>sC", function() snacks_picker().picker.commands() end, { desc = "[S]earch [C]ommands" })
map("n", "<leader>sH", function() snacks_picker().picker.help() end, { desc = "[S]earch [H]elp" })
map("n", "<leader>sk", function() snacks_picker().picker.keymaps() end, { desc = "[S]earch [k]eymaps" })
map("n", "<leader>sm", function() snacks_picker().picker.marks() end, { desc = "[S]earch [m]arks" })
map("n", "<leader>sq", function() snacks_picker().picker.qflist() end, { desc = "[S]earch [q]uickfix" })
map("n", "<leader>sr", function() snacks_picker().picker.registers() end, { desc = "[S]earch [r]egisters" })
map("n", "<leader>uC", function() snacks_picker().picker.colorschemes() end, { desc = "[U]I [C]olorschemes" })
map("n", "<leader>sGl", function() snacks_picker().picker.git_log() end, { desc = "[S]earch [G]it [L]og" })
map("n", "<leader>sGs", function() snacks_picker().picker.git_status() end, { desc = "[S]earch [G]it [S]tatus" })
